...
class CustPasswordReset extends StatefulWidget {
  @override
  _CustPasswordResetState createState() => _CustPasswordResetState();
}

class _CustPasswordResetState extends State<CustPasswordReset> {
        ...
        await myAuthMethods.updatePassword(newPassword).then((value) async {
          ...
          if (snapshot != null) {
            ...
            Navigator.pushReplacement(context,
                MaterialPageRoute(builder: (context) => CustMyDrawer()));
          }
        });
